Feature: Get Hello Error404
  ...
  Scenario: Access the English Hello Error-404 page
  ...
  Scenario: Access the Chinese (Simplified) Hello Error-404 page
    Given I am a visitor to "www.example.net"
    When I request "/zh/hello/error-404"
    Then the response status code should be 404
    And I should see "Not Found" in the response
    And I should see "The resource you are looking for could not be found on this server." in the response
    And I should see "UseLocalizedStatusCodePages" in the response
  ...
  Scenario: Access the Chinese (Traditional, Hong Kong) Hello Error-404 page
    Given I am a visitor to "www.example.net"
    When I request "/zh-hk/hello/error-404"
    Then the response status code should be 404
    And I should see "Not Found" in the response
    And I should see "The resource you are looking for could not be found on this server." in the response
    And I should see "UseLocalizedStatusCodePages" in the response
