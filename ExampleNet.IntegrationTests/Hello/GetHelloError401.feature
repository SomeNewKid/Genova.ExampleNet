Feature: Get Hello Error401
  ...
  Scenario: Access the English Hello Error-401 page
    ...
    And I should see "View for status 401 (401)" in the response
  ...
  Scenario: Access the Chinese (Simplified) Hello Error-401 page
    Given I am a visitor to "www.example.net"
    When I request "/zh/hello/error-401"
  ...
  Scenario: Access the Chinese (Traditional, Hong Kong) Hello Error-401 page
    Given I am a visitor to "www.example.net"
    When I request "/zh-hk/hello/error-401"
    Then the response status code should be 404
    And I should see "Not Found" in the response
    And I should see "The resource you are looking for could not be found on this server." in the response
    And I should see "UseLocalizedStatusCodePages" in the response
