Feature: Get Hello Error502
  ...
  Scenario: Access the English Hello Error-502 page
    ...
    And I should see "View for status 502 (502)" in the response
  ...
  Scenario: Access the Chinese (Simplified) Hello Error-502 page
    Given I am a visitor to "www.example.net"
    When I request "/zh/hello/error-502"
  ...
  Scenario: Access the Chinese (Traditional, Hong Kong) Hello Error-502 page
    Given I am a visitor to "www.example.net"
    When I request "/zh-hk/hello/error-502"
    Then the response status code should be 404
    And I should see "Not Found" in the response
    And I should see "The resource you are looking for could not be found on this server." in the response
    And I should see "UseLocalizedStatusCodePages" in the response
